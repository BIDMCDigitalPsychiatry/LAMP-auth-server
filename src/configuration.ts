...
const configuration: Configuration = {
  ...
  clients: [
      {
          client_id: 'mindlamp_server',
          client_secret: 'mindlamp_client_secret',
          grant_types: ['authorization_code'],
          response_types: ['code'],
          redirect_uris: ['http://localhost:3001/oauth'],
          post_logout_redirect_uris: ['http://localhost:3001'],
          tos_uri: "http://tosURL.com",
          policy_uri: "http://policyURL.com",
      }],
  claims: {
